...
- **THE PA SPEAKS ENGLISH IN EVERY LANGUAGE, AND IS SUBTITLED** (2026-09-02, by request). There is
  ...
  `Caption("pa.<key>")` beside any new line or it speaks with nothing on screen. `PaSubtitle` draws
  it. This is the signage rule below, not an exception to it: the PA is the facility talking to
