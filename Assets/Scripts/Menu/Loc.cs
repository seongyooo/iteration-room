...
namespace IterationRoom
{
    ...
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "set.tabGraphics",    "GRAPHICS" },
            { "set.tabAudio",       "AUDIO" },
            { "set.tabControls",    "CONTROLS" },
            { "set.tabGame",        "GAME" },
            ...
            { "note.accumulate1",    "Everything you do" },
        ...
        private static readonly Dictionary<string, string> Korean = new Dictionary<string, string>
        {
            ...
            { "set.tabGame",        "게임" },
            { "set.resolution",     "해상도" },
            { "set.fullscreen",     "전체 화면" },
            { "set.quality",        "품질" },
            { "set.qualityLow",     "낮음" },
            { "set.qualityMedium",  "보통" },
            { "set.qualityHigh",    "높음" },
            { "set.language",       "언어" },
            { "set.controls",       "조작" },
            { "set.subtitles",      "자막" },
            ...
            { "note.accumulate1",    "당신이 하는 모든 행동들은" },
