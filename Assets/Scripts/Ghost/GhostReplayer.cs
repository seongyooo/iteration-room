...
namespace IterationRoom
{
    ...
    public class GhostReplayer : MonoBehaviour
    {
        ...
        //
        // **THIS IS THE ONE THAT SURVIVED, AND SILENCE FROM IT IS NOW THE HEALTHY READING.** For a
        // day it had company - a line when a take was attempted and another when it succeeded -
        // added because an empty console had three meanings and no way to separate them. It served
        // its purpose: the mirror hand-overs came back clean, every attempt followed by a take and
        // not one refusal, which is what said the take path was not the fault. Two lines per take in
        // every future session is a price with nothing left to buy, so they went. If silence is ever
        // ambiguous again, a Debug.Log at the top of TryTake is the whole of what was removed.
