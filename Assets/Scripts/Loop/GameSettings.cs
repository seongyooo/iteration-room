...
namespace IterationRoom
{
    ...
    public static class GameSettings
    {
        ...
        // ~~RenderScale~~ MOVED TO `VideoSettings` 2026-09-05. It was the one graphics setting
        // this game had, exposed as a bare percentage; play could not tell what a given number
        // bought. It is part of the quality preset now, and the settings page offers a resolution
        // instead - a number people already know how to read.
        ...
        private static void ApplyOnLoad()
        {
            ApplyAudio();
            ApplyFrameCap();
            // Same argument as the two above: the pipeline asset and the window both ship at
            // whatever they were saved with, and nothing else would put the player's choice back.
            VideoSettings.Apply();
            VideoSettings.ApplyResolution();
        }
